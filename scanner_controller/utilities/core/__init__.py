...
# Define which symbols to export when using "from scanner_controller.utilities.core import *"
...
try:
    ...
    from scanner_controller.utilities.core.serial_utils import clear_serial_buffer
