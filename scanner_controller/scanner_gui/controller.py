...
from scanner_controller.utilities.log_utils import get_logger
...
class ScannerController:
    ...
    def _get_scanner_adapter(self):
        ...
        """
        try:
            # Use the scanner factory from scanner_controller.utilities
    ...
    def _send_direct_command(self, command, log_prefix="Command"):
        ...
        try:
            from scanner_controller.utilities.core.serial_utils import send_command
