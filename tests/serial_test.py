...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/serial_test.log"),
...
def test_send_command(port, command):
...
def main():
    ...
    # Test basic commands
    test_send_command(port, "MDL")
    time.sleep(0.5)
    
    # Test sending a key command
    test_send_command(port, "KEY,1")
    time.sleep(0.5)
    
    # Test reading display
    test_send_command(port, "STS")
